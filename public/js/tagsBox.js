document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSelectedOptions(customSelect) {
        ...
        if(selectedOptions.length === 0) {
            tagsHTML = '<span class="placeholder">Выберите тэги</span>'
        } else {
    ...
    customSelects.forEach(function(customSelect) {
        ...
        const option = customSelect.querySelector(".option")
        ...
        searchInput.addEventListener("input", function() {
            ...
            const anyOptionsMatch = Array.form(options).some(option => option.style.display === "block")
    ...
    document.addEventListener("click", function(event) {
        ...
        if(removeTag) {
            ...
            const optionToRemove = removeTag.getAttribute(".option[data-value='"+valueToRemove+"']")
