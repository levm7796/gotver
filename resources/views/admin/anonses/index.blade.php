...
@section('content')
<div class="mt-5">
    <h2>Список анонсов <a href="{{ route('admin.anonses.create') }}" class="btn btn-success"><i class="bi bi-plus-lg"></i></a></h2>
    <form action="" autocomplete="off">
        <div class="mt-2 mb-3 row gy-2 gx-3 align-items-center">
            ...
            <div class="col-1">
                <a href="/admin/anonses" class="btn btn-danger mb-1">Cброс</a>
          ...
          <tbody>
            @foreach ($articles as $new)
                <tr>
                    ...
                    <td>{{ $new->order }}</td>
                    <td>
                        <a href="{{ route('admin.anonses.edit', $new->id) }}" class="btn btn-primary m-2">
                            <i class="bi bi-pencil-fill"></i>
                        </a>
                        <span delete-btn hreff="{{ route('admin.anonses.destroy', $new->id) }}" pp="Имя: {{ $new->name }}" class="btn btn-danger m-2">
