...
{{--    <h1>{{$blocks}}</h1>--}}
    ...
    <form class="form-horizontal" method="POST" action="{{route('admin.news.edit', $news->id)}}" enctype="multipart/form-data" id="newsForm">
        @csrf
        ...
        <div class="form-group mt-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Title" name="title" value="{{ old('title', $news->title) }}">
            </div>
            @if ($errors->has('title'))
        ...
        <div class="form-group mt-3">
            ...
            <div class="col-sm-10">
               <textarea type="text" class="form-control summernote" placeholder="Description" name="description" value="{{ old('description', $news->description) }}"></textarea>
