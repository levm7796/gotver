...
<div class=" mt-5"> <!--  container -->
    <h2>Список новостей <a href="{{ route('admin.news.create') }}" class="btn btn-success"><i class="bi bi-plus-lg"></i></a></h2>
          ...
          <tbody>
            @foreach ($news as $new)
                <tr>
                    ...
                    <td>{{ $new->order }}</td>
                    <td>
                        <span restart-btn hreff="{{ route('admin.news.restart', $new->id) }}" pp="Вся статистика будет обноволена" class="btn btn-primary m-2">
                            <i class="bi bi-arrow-clockwise"></i>
                        </span>
                        <a href="{{ route('admin.news.edit', $new->id) }}" class="btn btn-primary m-2">
                            <i class="bi bi-pencil-fill"></i>
                        </a>
                        <span delete-btn hreff="{{ route('admin.news.destroy', $new->id) }}" pp="Имя: {{ $new->name }}" class="btn btn-danger m-2">
