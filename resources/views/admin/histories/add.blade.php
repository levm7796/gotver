...
@section('content')
    <div class="container mt-5">
        <h2>Создание серии истории для страницы</h2>
        <form class="form-horizontal" method="POST" action="{{route('admin.histories.store')}}">
            ...
            <div class="form-group mt-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="location/*" name="pattern" value="{{ old('pattern') }}">
                </div>
            ...
            <history :old="{{ old('content') }}" :name="'content'" :title="'Истории'"></history>
