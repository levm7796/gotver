...
{{--    <script src=".AdminLTE-3.0.5/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>--}}
    <div class="container mt-5">
        ...
        <form class="form-horizontal" method="POST" action="{{route('admin.articles.store')}}" enctype="multipart/form-data" id="newsForm">
            @csrf
            ...
            <div class="form-group mt-3">
                ...
                <div class="col-sm-10">
                   <textarea type="text" class="form-control summernote" placeholder="Название" name="description" value="{{ old('description') }}"></textarea>
            ...
            <tagsbox :data="{{ json_encode(['all' => $allTags, 'old' => old('tagsId')]) }}" :name="'tagsId[]'"></tagsbox>
...
{{--            </div>--}}
            ...
            <div class="form-group mt-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Время чтения: 8 минут" name="signature" value="{{ old('signature', '') }}">
                </div>
