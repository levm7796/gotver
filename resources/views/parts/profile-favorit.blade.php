<div class="card-item item-favorite is-favorite">
    ...
    <div class="card-item__text"><a class="card-item__text-wrapper" href="#">
            <p class="card-item__title">Объект Viewpoint Hotel</p>
            <p class="card-item__description">Господа, убеждённость некоторых оппонентов
                требует определения и уточнения форм воздействия. Каждый из нас понимает
                очевидную вещь: консультация с широким активом воздействия.</p>
        </a>
        <div class="card-item__info-panel">
            <div class="card-item__labels">
                <p class="label-item" data-tag="Отели Твери" data-color="red">Отели Твери
                </p>
            </div>
